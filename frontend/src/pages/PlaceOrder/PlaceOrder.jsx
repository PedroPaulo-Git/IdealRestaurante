...
//   console.log("BACK",backendUrl)
  ...
  const handlePayment = async () => {
    ...
    if (totalAmount > 0 && firstName && lastName && clientEmail) {
      try {
        // Create customer
        const response = await fetch(`${backendUrl}/api/create-customer/${clientId}`, {
          method: "POST",
          headers: {
          ...
          <div className='delivery-left-form'>
            ...
            {isEditing ? (
              ...
              <div className='form'>
                ...
                <button className='cart-total-details-button' onClick={() => setIsEditing(true)}>Editar/Adicionar Endereço</button>
              </div>
